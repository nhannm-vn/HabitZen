...
// @ts-nocheck 
/*
 * This file exports the `CelebrityHabitTemplate` model and its related types.
 *
...
export type CelebrityHabitTemplateAggregateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which CelebrityHabitTemplate to aggregate.
   */
  where?: Prisma.CelebrityHabitTemplateWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   * 
   * Determine the order of CelebrityHabitTemplates to fetch.
   */
   ...
   * 
   * Take `±n` CelebrityHabitTemplates from the position of the cursor.
   */
  take?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
   * 
   * Skip the first `n` CelebrityHabitTemplates.
   */
  skip?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
   * 
   * Count returned CelebrityHabitTemplates
  **/
...
export type GetCelebrityHabitTemplateAggregateType<T extends CelebrityHabitTemplateAggregateArgs> = {
      [P in keyof T & keyof AggregateCelebrityHabitTemplate]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCelebrityHabitTemplate[P]>
    : Prisma.GetScalarType<T[P], AggregateCelebrityHabitTemplate[P]>
}
...
export type GetCelebrityHabitTemplateGroupByPayload<T extends CelebrityHabitTemplateGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CelebrityHabitTemplateGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CelebrityHabitTemplateGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CelebrityHabitTemplateGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CelebrityHabitTemplateGroupByOutputType[P]>
      }
    >
  >
...
/**
 * Count Type CelebrityHabitTemplateCountOutputType
 */
...
/**
 * CelebrityHabitTemplateCountOutputType without action
 */
export type CelebrityHabitTemplateCountOutputTypeDefaultArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Select specific fields to fetch from the CelebrityHabitTemplateCountOutputType
   */
...
export type CelebrityHabitTemplateCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CelebrityHabitTemplateFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CelebrityHabitTemplateDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CelebrityHabitTemplate'], meta: { name: 'CelebrityHabitTemplate' } }
  /**
   * Find zero or one CelebrityHabitTemplate that matches the filter.
   * @param {CelebrityHabitTemplateFindUniqueArgs} args - Arguments to find a CelebrityHabitTemplate
   * @example
   * // Get one CelebrityHabitTemplate
   * const celebrityHabitTemplate = await prisma.celebrityHabitTemplate.findUnique({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find one CelebrityHabitTemplate that matches the filter or throw an error with `error.code='P2025'`
   * if no matches were found.
   * @param {CelebrityHabitTemplateFindUniqueOrThrowArgs} args - Arguments to find a CelebrityHabitTemplate
   * @example
   * // Get one CelebrityHabitTemplate
   * const celebrityHabitTemplate = await prisma.celebrityHabitTemplate.findUniqueOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first CelebrityHabitTemplate that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {CelebrityHabitTemplateFindFirstArgs} args - Arguments to find a CelebrityHabitTemplate
   * @example
   * // Get one CelebrityHabitTemplate
   * const celebrityHabitTemplate = await prisma.celebrityHabitTemplate.findFirst({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first CelebrityHabitTemplate that matches the filter or
   * throw `PrismaKnownClientError` with `P2025` code if no matches were found.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {CelebrityHabitTemplateFindFirstOrThrowArgs} args - Arguments to find a CelebrityHabitTemplate
   * @example
   * // Get one CelebrityHabitTemplate
   * const celebrityHabitTemplate = await prisma.celebrityHabitTemplate.findFirstOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find zero or more CelebrityHabitTemplates that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {CelebrityHabitTemplateFindManyArgs} args - Arguments to filter and select certain fields only.
   * @example
   * // Get all CelebrityHabitTemplates
   * const celebrityHabitTemplates = await prisma.celebrityHabitTemplate.findMany()
   * 
   * // Get first 10 CelebrityHabitTemplates
   * const celebrityHabitTemplates = await prisma.celebrityHabitTemplate.findMany({ take: 10 })
   * 
   * // Only select the `id`
   * const celebrityHabitTemplateWithIdOnly = await prisma.celebrityHabitTemplate.findMany({ select: { id: true } })
   * 
   */
  ...
  /**
   * Create a CelebrityHabitTemplate.
   * @param {CelebrityHabitTemplateCreateArgs} args - Arguments to create a CelebrityHabitTemplate.
   * @example
   * // Create one CelebrityHabitTemplate
   * const CelebrityHabitTemplate = await prisma.celebrityHabitTemplate.create({
   *   data: {
   *     // ... data to create a CelebrityHabitTemplate
   *   }
   * })
   * 
   */
  ...
  /**
   * Create many CelebrityHabitTemplates.
   * @param {CelebrityHabitTemplateCreateManyArgs} args - Arguments to create many CelebrityHabitTemplates.
   * @example
   * // Create many CelebrityHabitTemplates
   * const celebrityHabitTemplate = await prisma.celebrityHabitTemplate.createMany({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
  ...
  /**
   * Create many CelebrityHabitTemplates and returns the data saved in the database.
   * @param {CelebrityHabitTemplateCreateManyAndReturnArgs} args - Arguments to create many CelebrityHabitTemplates.
   * @example
   * // Create many CelebrityHabitTemplates
   * const celebrityHabitTemplate = await prisma.celebrityHabitTemplate.createManyAndReturn({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   * 
   * // Create many CelebrityHabitTemplates and only return the `id`
   * const celebrityHabitTemplateWithIdOnly = await prisma.celebrityHabitTemplate.createManyAndReturn({
   *   select: { id: true },
   *   data: [
   *     // ... provide data here
   *   ]
  ...
  /**
   * Delete a CelebrityHabitTemplate.
   * @param {CelebrityHabitTemplateDeleteArgs} args - Arguments to delete one CelebrityHabitTemplate.
   * @example
   * // Delete one CelebrityHabitTemplate
   * const CelebrityHabitTemplate = await prisma.celebrityHabitTemplate.delete({
   *   where: {
   *     // ... filter to delete one CelebrityHabitTemplate
   *   }
   * })
   * 
   */
  ...
  /**
   * Update one CelebrityHabitTemplate.
   * @param {CelebrityHabitTemplateUpdateArgs} args - Arguments to update one CelebrityHabitTemplate.
   * @example
   * // Update one CelebrityHabitTemplate
   * const celebrityHabitTemplate = await prisma.celebrityHabitTemplate.update({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Delete zero or more CelebrityHabitTemplates.
   * @param {CelebrityHabitTemplateDeleteManyArgs} args - Arguments to filter CelebrityHabitTemplates to delete.
   * @example
   * // Delete a few CelebrityHabitTemplates
   * const { count } = await prisma.celebrityHabitTemplate.deleteMany({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Update zero or more CelebrityHabitTemplates.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {CelebrityHabitTemplateUpdateManyArgs} args - Arguments to update one or more rows.
   * @example
   * // Update many CelebrityHabitTemplates
   * const celebrityHabitTemplate = await prisma.celebrityHabitTemplate.updateMany({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Update zero or more CelebrityHabitTemplates and returns the data updated in the database.
   * @param {CelebrityHabitTemplateUpdateManyAndReturnArgs} args - Arguments to update many CelebrityHabitTemplates.
   * @example
   * // Update many CelebrityHabitTemplates
   * const celebrityHabitTemplate = await prisma.celebrityHabitTemplate.updateManyAndReturn({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: [
   ...
   * })
   * 
   * // Update zero or more CelebrityHabitTemplates and only return the `id`
   * const celebrityHabitTemplateWithIdOnly = await prisma.celebrityHabitTemplate.updateManyAndReturn({
   *   select: { id: true },
   *   where: {
   *     // ... provide filter here
   *   },
  ...
  /**
   * Create or update one CelebrityHabitTemplate.
   * @param {CelebrityHabitTemplateUpsertArgs} args - Arguments to update or create a CelebrityHabitTemplate.
   * @example
   * // Update or create a CelebrityHabitTemplate
   * const celebrityHabitTemplate = await prisma.celebrityHabitTemplate.upsert({
   *   create: {
   *     // ... data to create a CelebrityHabitTemplate
   *   },
   *   update: {
   ...
   *   },
   *   where: {
   *     // ... the filter for the CelebrityHabitTemplate we want to update
   *   }
   * })
   */
  ...
  /**
   * Count the number of CelebrityHabitTemplates.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {CelebrityHabitTemplateCountArgs} args - Arguments to filter CelebrityHabitTemplates to count.
   * @example
   * // Count the number of CelebrityHabitTemplates
   * const count = await prisma.celebrityHabitTemplate.count({
   *   where: {
   *     // ... the filter for the CelebrityHabitTemplates we want to count
   *   }
   * })
  **/
  count<T extends CelebrityHabitTemplateCountArgs>(
    args?: Prisma.Subset<T, CelebrityHabitTemplateCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CelebrityHabitTemplateCountAggregateOutputType>
      : number
  >

  /**
   * Allows you to perform aggregations operations on a CelebrityHabitTemplate.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {CelebrityHabitTemplateAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
   * @example
  ...
  **/
  ...
  /**
   * Group by CelebrityHabitTemplate.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {CelebrityHabitTemplateGroupByArgs} args - Group by arguments.
   * @example
  ...
  **/
  groupBy<
    T extends CelebrityHabitTemplateGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CelebrityHabitTemplateGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCelebrityHabitTemplateGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
 * Fields of the CelebrityHabitTemplate model
 */
readonly fields: CelebrityHabitTemplateFieldRefs;
}

/**
 * The delegate class that acts as a "Promise-like" for CelebrityHabitTemplate.
...
// Custom InputTypes
/**
 * CelebrityHabitTemplate findUnique
 */
export type CelebrityHabitTemplateFindUniqueArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  /**
   * Filter, which CelebrityHabitTemplate to fetch.
   */
  where: Prisma.CelebrityHabitTemplateWhereUniqueInput
}

/**
 * CelebrityHabitTemplate findUniqueOrThrow
 */
...
/**
 * CelebrityHabitTemplate findFirst
 */
export type CelebrityHabitTemplateFindFirstArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for searching for CelebrityHabitTemplates.
   */
  cursor?: Prisma.CelebrityHabitTemplateWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
/**
 * CelebrityHabitTemplate findMany
 */
export type CelebrityHabitTemplateFindManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.CelebrityHabitTemplateInclude<ExtArgs> | null
  /**
   * Filter, which CelebrityHabitTemplates to fetch.
   */
  where?: Prisma.CelebrityHabitTemplateWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for listing CelebrityHabitTemplates.
   */
  cursor?: Prisma.CelebrityHabitTemplateWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type CelebrityHabitTemplateCreateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to create many CelebrityHabitTemplates.
   */
...
/**
 * CelebrityHabitTemplate createManyAndReturn
 */
...
export type CelebrityHabitTemplateUpdateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.CelebrityHabitTemplateInclude<ExtArgs> | null
  /**
   * The data needed to update a CelebrityHabitTemplate.
   */
  data: Prisma.XOR<Prisma.CelebrityHabitTemplateUpdateInput, Prisma.CelebrityHabitTemplateUncheckedUpdateInput>
  /**
   * Choose, which CelebrityHabitTemplate to update.
   */
  where: Prisma.CelebrityHabitTemplateWhereUniqueInput
}

/**
 * CelebrityHabitTemplate updateMany
 */
export type CelebrityHabitTemplateUpdateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to update CelebrityHabitTemplates.
   */
  ...
  /**
   * Filter which CelebrityHabitTemplates to update
   */
  where?: Prisma.CelebrityHabitTemplateWhereInput
  /**
   * Limit how many CelebrityHabitTemplates to update.
   */
  limit?: number
}

/**
 * CelebrityHabitTemplate updateManyAndReturn
 */
...
export type CelebrityHabitTemplateUpsertArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.CelebrityHabitTemplateInclude<ExtArgs> | null
  /**
   * The filter to search for the CelebrityHabitTemplate to update in case it exists.
   */
  where: Prisma.CelebrityHabitTemplateWhereUniqueInput
  /**
   * In case the CelebrityHabitTemplate found by the `where` argument doesn't exist, create a new CelebrityHabitTemplate with this data.
   */
  create: Prisma.XOR<Prisma.CelebrityHabitTemplateCreateInput, Prisma.CelebrityHabitTemplateUncheckedCreateInput>
  /**
   * In case the CelebrityHabitTemplate was found with the provided `where` argument, update it with this data.
   */
  update: Prisma.XOR<Prisma.CelebrityHabitTemplateUpdateInput, Prisma.CelebrityHabitTemplateUncheckedUpdateInput>
}

/**
 * CelebrityHabitTemplate delete
 */
export type CelebrityHabitTemplateDeleteArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.CelebrityHabitTemplateInclude<ExtArgs> | null
  /**
   * Filter which CelebrityHabitTemplate to delete.
   */
  where: Prisma.CelebrityHabitTemplateWhereUniqueInput
}

/**
 * CelebrityHabitTemplate deleteMany
 */
export type CelebrityHabitTemplateDeleteManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which CelebrityHabitTemplates to delete
   */
  where?: Prisma.CelebrityHabitTemplateWhereInput
  /**
   * Limit how many CelebrityHabitTemplates to delete.
   */
  limit?: number
}

/**
 * CelebrityHabitTemplate.category
 */
...
/**
 * CelebrityHabitTemplate.creator
 */
...
/**
 * CelebrityHabitTemplate.importedByUsers
 */
...
/**
 * CelebrityHabitTemplate without action
 */
