...
const categories_service_1 = require("../../routes/categories/categories.service");
...
let BootstrapService = BootstrapService_1 = class BootstrapService {
    ...
    constructor(prisma, categoriesService, config) {
        this.prisma = prisma;
    ...
    async seedAdmin() {
        ...
        await this.prisma.user.create({
            data: {
                ...
                fullName: this.config.get('admin.fullName') ?? 'System Admin',
